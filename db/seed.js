...
const seedDB = async () => {
  try {
    ...
    await pool.query(`
      ...
      (15, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199200/souste-social-profile-pics/sigismund.jpg', 
       'Emperor and conqueror. The crown bends to my will.', 
       'Hungary', '1368-02-14', 'Emperor', 0),
      (16, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199201/souste-social-profile-pics/zizka.jpg', 
       'One-eyed warrior. I fight for the people, not the crown.', 
       'Kutna Hora', '1360-06-10', 'Commander', 0),
      (17, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199202/souste-social-profile-pics/drydevil.jpg', 
       'Outlaw of the woods. Fear my name in the shadows.', 
       'Bohemian Forest', '1370-04-20', 'Bandit', 0),
      (18, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199203/souste-social-profile-pics/kubyenka.jpg', 
       'Cunning lass with a sharp tongue and sharper blade.', 
       'Kutna Hora', '1385-07-12', 'Thief', 0),
      (19, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199204/souste-social-profile-pics/musa.jpg', 
       'Traveler from afar. My spear speaks when words fail.', 
       'Kutna Hora', '1378-03-05', 'Mercenary', 0),
      (20, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199205/souste-social-profile-pics/samuel.jpg', 
       'Son of Martin, I forge steel and secrets with a quiet hammer.', 
       'Sasau', '1380-09-15', 'Blacksmith', 0),
      (21, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199206/souste-social-profile-pics/jobst.jpg', 
       'Margrave with ambition. Power is my birthright.', 
       'Moravia', '1354-12-01', 'Noble', 0),
      (22, 'https://res.cloudinary.com/dbkarqkym/image/upload/v1744199207/souste-social-profile-pics/rosa.jpg', 
